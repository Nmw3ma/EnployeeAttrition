    ...
    <div class="row">
        <div class="col-md-12 page-header">
            <h2 class="page-title">
                ...
                <a href="{{ url('admin/user/roles/add') }}" class="btn btn-outline-primary btn-sm float-right">
                    <i class="fas fa-plus"></i><span class="button-with-icon">{{ __("Add") }}</span>
                </a>

                <a href="{{ url('/admin/users') }}" class="btn btn-outline-primary btn-sm float-right mr-1">
