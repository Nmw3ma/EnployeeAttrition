...
@section('meta')
    <title>Dashboard | Attrition Prediction</title>
...
<div class="container">
    <div class="jumbotron shadow-sm bg-white">
      ...
      <p class="lead">Attrition Prediction {{ __("dashboard provides an overview of the application's key information") }}</p>
    ...
    <div class="row">
        ...
        <div class="col-md-3 mb-4">
            <div class="card bg-light-blue border-0 shadow-sm">
                <div class="card-body text-dark">
                    <p class="mb-0">{{ __("Total Number of Predicted Attrition Records") }}</p>
        ...
        <div class="col-md-3 mb-4">
            <div class="card bg-light-gray border-0 shadow-sm">
                <div class="card-body text-dark">
                    <p class="mb-0">{{ __("Total Number of Scheduled Predictions") }} <span class="text-muted">({{ __("Active") }})</span></p>
        ...
        <div class="col-md-3 mb-4">
            <div class="card bg-light-violet border-0 shadow-sm">
                <div class="card-body text-dark">
                    <p class="mb-0">{{ __("Total Number of Likely Employees to Leave") }} <span class="text-muted">({{ __("Approved") }})</span></p>
