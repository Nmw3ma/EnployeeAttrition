	...
	Route::group(['middleware' => 'checkstatus'], function () {
		...
		Route::group(['middleware' => 'admin'], function () {
			...
			*/
			...
			|--------------------------------------------------------------------------
			*/
			Route::get('admin/attrition', 'Admin\AttritionController@index')->name('admin-attrition');
			Route::post('admin/attrition', 'Admin\AttritionController@filter');
			Route::get('admin/attrition/manual-entry', 'Admin\AttritionController@add');
			Route::post('admin/attrition/add-entry', 'Admin\AttritionController@entry');
			Route::get('admin/attrition/delete/{id}', 'Admin\AttritionController@delete');
